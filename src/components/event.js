...
export const createEvent = ({tripPointType, destinations, startDate, finishDate, price, offers}) => {
  return `<li class="trip-events__item">
    <div class="event">
      <div class="event__type">
        <img class="event__type-icon" width="42" height="42" src="img/icons/${tripPointType.name}.png" alt="Event type icon">
      </div>
      <h3 class="event__title">${tripPointType.name} ${tripPointType.move ? ` to` : ` in`} ${destinations}</h3>
